...
const ClassDetails = () => {
    ...
    const getAClassDetails = async (id) => {
        console.log(id,"id for fetching class data")
        try {
    ...
    return (
        <div className='bg-[#F8F9FC] md:px-10 px-2 py-6'>
            ...
            <div className='flex justify-between md:gap-10 gap-4'>
                <div className='w-2/5'>
                    <div className='w-full border text-xl  font-semibold bg-[#eeeaea] rounded-sm px-2 py-2'>Total Students {students?.length}</div>
                    <ul>
